...
namespace Sigtrap.VrTunnellingPro {
	...
	/// </summary>
	public abstract class TunnellingMobileBase : TunnellingBase {
		#region Consts
		/// <summary>
		...
		/// Refers to a <see cref="TunnellingMobileBase"/> effect.<br />
		/// Will not refer to a <see cref="Tunnelling"/> or <see cref="TunnellingOpaque"/> effect.
		/// </summary>
		public static TunnellingMobileBase instance { get; private set; }
		...
		protected Material _irisMatOuter {get; private set;}
		protected Material _irisMatInner {get; private set;}
		Mesh _irisMesh;
